package com.example.user.fast.manager;

import android.content.Context;

import com.example.user.fast.R;
import com.example.user.fast.data.PreferenceGroup;
import com.example.user.fast.module.CameraModule;
import com.example.user.fast.module.DualCameraModule;
import com.example.user.fast.ui.IndicatorView;
import com.example.user.fast.utils.XmlInflater;
...
public class ModuleManager implements IndicatorView.IndicatorListener {
    ...
    private static int mCurrentIndex = 0;//by mibb 3.19 first 1
