...
import com.example.user.fast.callback.CameraUiEvent;
import com.example.user.fast.callback.MenuInfo;
import com.example.user.fast.callback.RequestCallback;
import com.example.user.fast.manager.CameraSettings;
import com.example.user.fast.manager.Controller;
import com.example.user.fast.manager.DeviceManager;
import com.example.user.fast.manager.FocusOverlayManager;
import com.example.user.fast.manager.Session;
import com.example.user.fast.manager.SingleDeviceManager;
import com.example.user.fast.manager.VideoSession;
import com.example.user.fast.ui.CameraBaseMenu;
import com.example.user.fast.ui.CameraMenu;
import com.example.user.fast.ui.ShutterButton;
import com.example.user.fast.ui.VideoUI;
import com.example.user.fast.utils.FileSaver;
import com.example.user.fast.utils.JobExecutor;
import com.example.user.fast.utils.MediaFunc;
