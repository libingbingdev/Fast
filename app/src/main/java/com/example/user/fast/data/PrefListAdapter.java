package com.example.user.fast.data;
...
public class PrefListAdapter extends RecyclerView.Adapter<PrefListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (TextUtils.isEmpty(preference.getTitle())) {
            ...
            holder.itemText.setVisibility(View.GONE);//by mibb
        ...
        if (CamListPreference.RES_NULL == preference.getIcon()) {
            ...
            holder.itemIcon.setVisibility(View.GONE);//by mibb
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                    //mListener.onClick(v, position, mGroup.get(position)); //by mibb
                }
            }
        });
    }
