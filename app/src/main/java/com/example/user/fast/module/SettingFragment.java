...
import com.example.user.fast.utils.SupportInfoDialog;
...
public class SettingFragment extends PreferenceFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.camera_setting);//by mibb 3.19
        PreferenceManager.setDefaultValues(getActivity(), R.xml.camera_setting, false);//by mibb 3.19
        initPreference();//by mibb 3.19
